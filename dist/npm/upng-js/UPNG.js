...
if (typeof require == "function") {pako = require('./../pako/index.js');}  else {pako = window.pako;}
function log() { if (typeof process=="undefined" || undefined=="development") console.log.apply(console, arguments);  }
(function(UPNG, pako){
